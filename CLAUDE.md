...
Reste à faire : facturation Stripe (`foyers.statut_abonnement`), gestion des membres/invitations (tables prêtes), onboarding (nom du foyer), sous-listes Événements. [[pivot-saas-multi-foyer]]
