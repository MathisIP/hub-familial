/**
 * SUIVI CADEAUX — MENU « 🎁 Cadeaux »
 * ===================================
 * Menu ajouté à l'ouverture de la feuille :
 *   · En haut : l'action courante (réappliquer la mise en forme / couleurs).
...
function onOpen() {
  ...
  ui.createMenu("🎁 Cadeaux")
    .addItem("🎨 Configurer les couleurs / statuts", "configurerCadeaux")
    ...
    .addSubMenu(ui.createMenu("⚙️ Configuration")
      .addItem("🚀 Tout installer / configurer (1er lancement)", "initialiserCadeaux")
      .addItem("🔍 Vérifier la configuration", "verifierCadeaux")
      .addItem("♻️ Réinitialiser les exemples…", "reinitialiserExemplesCadeaux")
