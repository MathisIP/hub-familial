 ...
 * connexion (/connexion), la politique de confidentialité (/confidentialite), la
 * page de repli hors ligne (/hors-ligne), le service worker (/sw.js), les fichiers
 * statiques Next, et les assets publics (.png/.ico/.webmanifest — icônes, favicon,
